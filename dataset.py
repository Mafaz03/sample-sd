...
if __name__ == "__main__":
    ds = Image_dataset(root_dir="Dataset/Train", inter_images=1, binarize_output = False, grayscale_all=False)
    ...
    # print("Inter4 image: ", z5.shape)
    # print("Inter4 image: ", z6.shape)
